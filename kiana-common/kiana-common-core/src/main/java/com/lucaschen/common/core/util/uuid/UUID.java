package com.lucaschen.common.core.util.uuid;
...
public final class UUID implements Comparable<UUID> {
    ...
    public static SecureRandom getSecureRandom() {
        try {
            ...
            log.error("UUID::getSecureRandom", e);
            throw new GlobalException(UtilExceptionCode.UTIL_UUID_001);
        }
    }

    /**
     * 获取随机数生成器对象<br>
     * ThreadLocalRandom 是 JDK 7 之后提供并发产生随机数，能够解决多个线程发生的竞争争夺。
     *
