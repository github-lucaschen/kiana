...
import com.lucaschen.common.core.constant.SecurityConstants;
import com.lucaschen.common.core.constant.TokenConstants;
...
public final class JwtUtils {
     ...
     * @return 用户ID
     */
    public static String getUserKey(final String token) {
     ...
     * @return 用户ID
     */
    public static String getUserKey(final Claims claims) {
        return getValue(claims, SecurityConstants.USER_KEY);
    }
     ...
     * @return 用户名
     */
    public static String getUserName(final Claims claims) {
        return getValue(claims, SecurityConstants.DETAILS_USERNAME);
    }
     ...
     * @return 值
     */
    public static String getValue(final Claims claims, final String key) {
        final Object object = claims.get(key);
